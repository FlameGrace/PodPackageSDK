...
Pod::Spec.new do |s|
  s.name             = 'FGFoundationSDK'
  s.version          = '##PackageTag##'
  s.summary          = 'A short description of FGFoundationSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/flamegrace/FGFoundationSDK'
  ...
  s.source_files = "FGFoundationSDK","Classes/**/*.{h,m,plist,cfg,jet,cpp,mm}"
